...
CREATE TABLE salles (
  ...
  type VARCHAR(20) NOT NULL CHECK (type IN ('bar','salle','zenith','arena','festival'))
);
...
SELECT setval('salles_id_seq', 15);
...
CREATE TABLE concerts (
  ...
  id_salle INTEGER NOT NULL REFERENCES salles(id),
...
SELECT setval('concerts_id_seq', 28);
...
SELECT setval('propositions_id_seq', 2);